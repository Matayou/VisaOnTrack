    ...
    <div className="ios-card overflow-hidden">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs text-gray-400 font-medium flex items-center gap-1">
              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
              </svg>
              Edited {updatedAt}
            </span>
          </div>
      ...
      <div className="bg-gray-50/50 p-5 lg:p-6 space-y-6">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200/80 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <span className="text-gray-500 text-[11px] uppercase tracking-wide block mb-0.5">Estimated Budget</span>
